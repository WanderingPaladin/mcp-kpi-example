...
Anonymous review PDFs and a Greenhouse-ready ZIP (no candidate name, no `.env`) are in `submission/`. Rebuild with `python submission/build_pdfs.py` then `python submission/pack_zip.py`.
